...
# Privacy Policy
This privacy policy is applicable to the ganttLify app (hereinafter referred to as "Application") for mobile devices, which was developed by Antoine Aoun (hereinafter referred to as "Service Provider") as a Freemium service. This service is provided "AS IS".
...
Apple app store Services https://www.apple.com/legal/privacy/data/en/app-store/#:~:text=We%20process%20your%20personal%20data,accordance%20with%20applicable%20local%20law.
MongoDb Services https://www.mongodb.com/legal/privacy/privacy-policy
AdMob https://support.google.com/admob/answer/6128543?hl=en
Firebase Crashlytics, Google Analytics for Firebase, Firebase Messaging etc.. https://firebase.google.com/support/privacy/
...
The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. The Service Provider will retain Automatically Collected information for up to 24 months and thereafter may store it in aggregate. If you'd like the Service Provider to delete User Provided Data that you have provided via the Application, please contact them at antoinenaoun@gmail.com and we will respond in a reasonable time. Please note that some or all of the User Provided Data may be required in order for the Application to function properly.
...
## Contact us
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at antoinenaoun@gmail.com.
